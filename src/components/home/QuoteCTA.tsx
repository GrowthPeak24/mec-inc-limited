...
export function QuoteCTA() {
  return (
    ...
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_80%_0%,color-mix(in_srgb,var(--color-sapphire)_22%,transparent),transparent_60%)]"
      />
      <div
        aria-hidden
