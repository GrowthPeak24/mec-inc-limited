        ...
        {SERVICE_PILLARS.map((p) => (
          <div key={p.id}>
            <Link
              ...
              className="group inline-flex items-center gap-2 text-lg font-semibold tracking-tight text-[var(--color-ink)] transition-colors duration-[var(--duration-control)] hover:text-[var(--color-sapphire)]"
            >
              {p.name}
              <svg
                width="14"
